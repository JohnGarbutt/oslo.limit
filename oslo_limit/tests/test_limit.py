...
class TestEnforcerUtils(base.BaseTestCase):
    def test_get_endpoint(self):
        ...
        mock_conn.get_endpoint.return_value = fake_endpoint
    ...
    def test_get_registered_limit_empty(self):
        mock_conn = mock.MagicMock()
        mock_conn.registered_limits.return_value = iter([])
    ...
    def test_get_registered_limit(self):
        ...
        mock_conn.registered_limits.return_value = iter([foo])
    ...
    def test_get_project_limits(self):
        ...
        a.resource_limit = 1
        a_iterator = iter([a])
        mock_conn.limits.side_effect = [a_iterator, empty_iterator,
                                        empty_iterator]
        ...
        b.default_limit = 2
        b_iterator = iter([b])
        mock_conn.registered_limits.side_effect = [b_iterator, empty_iterator]
